                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <button class="btn btn-primary" name="btn_artikel_baru" data-bs-toggle="modal" data-bs-target="#modalFormKategori">
                                Kategori baru
                                </button> 
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <button class="btn btn-warning" name="btn-ubah-kategori" data-bs-toggle="modal" data-bs-target="#modalFormUpdateKategori<?php echo $data_id_kategori; ?>">Ubah</button>
                                            <button class="btn btn-danger" name="btn-hapus-kategori" data-bs-toggle="modal" data-bs-target="#modalFormHapusKategori<?php echo $data_id_kategori; ?>">Hapus</button>
                                            </td>
                                        </tr>
                                            ...
                                            <!-- The Modal Hapus Kategori -->
                                            <div class="modal fade" id="modalFormHapusKategori<?php echo $data_id_kategori; ?>">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                ...
                                                <form method="POST">
                                                    ...
                                                    <input type="hidden" name="id-hapus-kategori" value="<?php echo $data_id_kategori;?>">
